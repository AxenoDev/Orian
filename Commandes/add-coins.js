...
module.exports = {
    name: "add-coins",
    description: "Ajoute de l'argent à un membre du serveur",
    ...
    options: [
        {
            type: "user",
            name: "membre",
            description: "Le membre à qui rajouter l'argent",
            required: true,
            autocomplete: true,
        },
        {
            type: "string",
            name: "coins",
            description: "Le nombre d'argent à rajouter",
            required: true,
            autocomplete: false,
        }
    ],
